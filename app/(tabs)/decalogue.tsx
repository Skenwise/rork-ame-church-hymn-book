          ...
          return (
            <View key={index} style={styles.lineWrapper}>
              <View style={[styles.lineContainer, isLocked && styles.lineBlurred]}>
                <Text style={[styles.role, isDark ? styles.roleDark : styles.roleLight, { fontSize: Math.round(16 * textScale) }, isLocked && styles.lockedText]}>
                  {line.role}
                </Text>
                <Text style={[styles.text, isDark ? styles.textDark : styles.textLight, { fontSize: Math.round(17 * textScale), lineHeight: Math.round(28 * textScale) }, isLocked && styles.lockedText]}>
                  {line.text}
                </Text>
              </View>
              ...
              {!isPaid && index === FREE_PREVIEW_LINES && (
                <View style={[styles.lockOverlay, isDark ? styles.lockOverlayDark : styles.lockOverlayLight]}>
                  ...
                  <Text style={[styles.lockSubtext, isDark ? styles.subtextDark : styles.subtextLight]}>
                    Sign in to read the full Decalogue
                  </Text>
                  <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  role: { fontSize: 16, fontWeight: "700" as const, marginBottom: 8 },
  ...
  lockOverlay: { borderRadius: 16, padding: 24, alignItems: "center", marginBottom: 16, borderWidth: 1 },
